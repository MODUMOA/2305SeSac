<template>
  <div class="col-12 main_badge_list_con">
    ...
    <ul class="col-12 main_badge_list">
      <li>
        <img :src="this.$resource.themeRes.img('sonamu_icon.png')" alt="소나무"/>
        <span>소나무</span>
      </li>
      <li>
        <img :src="this.$resource.themeRes.img('sangsuri_icon.png')" alt="상수리나무"/>
        <span>상수리나무</span>
      </li>
    </ul>
  </div>
