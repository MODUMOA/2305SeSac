    ...
    <div class="col-12 dashboard_contents_2_con">
      <div class="col-12 dashboard_contents_2">
        <div class="col-12 dashboard_contents_2_inner">
          <div class="col-12">
            <div class="col-12 mb12 dashboard_contents_2_title">일주일 배출량</div>
            ...
            <div class="col-12 tc dashboard_contents_2_desc">
              이번주 평균 배출량은 <span class="fontweight500">{{ trashInfo.avg }}g</span>, 총
              배출량은 <span class="fontweight500">{{ trashInfo.total }}g</span> 입니다.
            </div>
          </div>
        </div>
        <div class="col-6 dashboard_contents_2_inner">
          <div class="col-12 tc">
            <div class="col-12 mb7 dashboard_contents_2_title">전 주 대비 증감량</div>
            <div
              :class="[
                trashInfo.prevPercentStatus
                  ? 'col-12 mb7 dashboard_contents_2_headline point1'
                  : 'col-12 mb7 dashboard_contents_2_headline warning',
              ]"
            >
        ...
        <div class="col-6 dashboard_contents_2_inner">
          <div class="col-12 tc">
            <div class="col-12 mb7 dashboard_contents_2_title">1인 평균 대비 증감량</div>
            <div
              :class="[
                trashInfo.avgPercentStatus
                  ? 'col-12 mb7 dashboard_contents_2_headline point1'
                  : 'col-12 mb7 dashboard_contents_2_headline warning',
              ]"
            >
