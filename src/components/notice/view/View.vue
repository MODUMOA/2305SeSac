  ...
  data() {
    return {
      view : {
        ...
        userContent : '공동주택 경비업무에 대한 경비업법 적용(경찰청 제공) 안녕하십니까? “아파트 관리소 사람들”입니다. 공동주택 경비업의 업무범위 명확화와 관련 "공동주택에 경비원을 배치한 경비업자(「경비업법」 제4조 제1항에 따라 허가를 받은 경비업자를 말한다)는 경비업법 제7조 제5항에도 불구하고 대통령령으로 정하는 공동주택관리에 필요한 업무에 경비원을 종사하게 할 수 있다"는 공동주택법이 개정. 공포되어 2021년 10월 21일 시행을 앞두고 있습니다. 공동주택 경비업무에 대한 경비업법 적용관련 안내사항을 숙독하시기 바랍니다.'
      }
    }
  },
  created() {
