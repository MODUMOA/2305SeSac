...
async function checkId(userId, success, fail) {
  await api
    .get(path + `/checkDuplicateId/${userId}`)
    .then(success)
    .catch(fail);
}
...
async function signUp(user, success, fail) {
  await api
    .post(path + `/signup`, JSON.stringify(user))
    .then(success)
    .catch(fail);
}
...
async function login(user, success, fail) {
  await api
    .post(path + `/login`, JSON.stringify(user))
    .then(success)
    .catch(fail);
}
...
async function findId(user, success, fail) {
  await api
    .post(path + `/findId`, JSON.stringify(user))
    .then(success)
    .catch(fail);
}
...
async function findPw(user, success, fail) {
  await api
    .post(path + `/findPw`, JSON.stringify(user))
    .then(success)
    .catch(fail);
}
